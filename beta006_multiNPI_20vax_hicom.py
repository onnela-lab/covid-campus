...
This code was run in parallel on a computing cluster using the following bash command:
    python beta006_multiNPI_20vax_hicom.py $SLURM_ARRAY_TASK_ID
...
sim_name = 'beta006_multiNPI_20vax_hicom'
...
vax_props = np.linspace(0.2, 0.2, 1)
